...
def productDetails(productid=None):
    ...
    if form.validate_on_submit():
        if current_user.get_id() != None:
            ...
            reviews = ProductReview.get_all_by_pid(productid)
    return render_template('product_detailed.html', avail_products = product, sellers=sellers, reviews = reviews, form = form, pid = productid, avgreview = avgreview, numreview =numreview)
